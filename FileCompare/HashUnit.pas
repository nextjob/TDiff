...
// -----------------------------------------------------------------------------
//
// Modifications made for Delphi 10. by Nextjob Solutions
// Base on the information provided here:
//  https://stackoverflow.com/questions/54372213/calccrc32-for-64-bit-programs

interface

uses
  system.Character, SysUtils, system.Types;

// function HashLine(const line: string; IgnoreCase, IgnoreBlanks: boolean): pointer;
function HashLine(const line: string;
  IgnoreCase, IgnoreBlanks: boolean): Integer;
...
function CalcCRC32(p: PByte; length: NativeUInt): integer;
// CRC algorithm courtesy of Earl F. Glynn ...
// (http://www.efg2.com/Lab/Mathematics/CRC.htm)
var
  i: NativeUInt;
